...
public class AdvertisementPlay {
    ...
    private static final String baseUrl = "http://www.yezixigua.cn:3000";
    private static final String configUrl = baseUrl + "/ads";
    private static final String imgCache = "imgCache";
    File imgCacheFolder;
